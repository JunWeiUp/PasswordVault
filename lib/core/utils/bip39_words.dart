class Bip39Words {
  static const List<String> wordList = [
    ...
    'assist', 'assume', 'asthma', 'astonish', 'athlete', 'atom', 'attack', 'attend', 'attitude', 'attract',
    ...
    'badge', 'bag', 'baggage', 'bakery', 'balance', 'balcony', 'ball', 'bamboo', 'banana', 'banner',
    'bar', 'bare', 'bargain', 'barrel', 'base', 'basic', 'basket', 'battle', 'beach', 'beam',
    ...
    'candy', 'cannon', 'canoe', 'canvas', 'canyon', 'capable', 'capital', 'captain', 'caption', 'car',
    ...
    'clarity', 'clasp', 'class', 'clause', 'clay', 'clean', 'clear', 'climb', 'clinic', 'clip',
    ...
    'combine', 'come', 'comfort', 'comic', 'common', 'company', 'compass', 'compete', 'confirm', 'confront',
    'confusion', 'congratulate', 'congress', 'connect', 'consider', 'control', 'convince', 'cook', 'cool', 'copper',
    'copy', 'coral', 'core', 'corn', 'corner', 'cost', 'cotton', 'couch', 'country', 'couple',
    ...
    'scratch', 'screen', 'script', 'scrub', 'sea', 'search', 'season', 'seat', 'second', 'secret',
    ...
    'substitute', 'subway', 'success', 'such', 'sudden', 'suffer', 'sugar', 'suggest', 'suit', 'summer',
    ...
    'tattoo', 'taxi', 'tea', 'teach', 'team', 'tell', 'ten', 'tenant', 'tennis', 'tent',
    ...
    'valley', 'valve', 'van', 'vanish', 'vapor', 'various', 'vast', 'vault', 'vector', 'vegetable',
    'vehicle', 'velvet', 'vendor', 'venture', 'venue', 'verb', 'verify', 'vessel', 'veteran', 'vibrant',
